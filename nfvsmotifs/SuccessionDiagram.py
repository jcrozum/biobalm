...
class SuccessionDiagram():
    ...
    def expand_attractors(self, node_id: int) -> list[dict[str, int]]:
        ...
        terminal_restriction_space = get_terminal_restriction_space(child_spaces, use_single_node_drivers=False, use_tr_trapspaces=False)

        # use single node drivers
        # terminal_restriction_space = get_terminal_restriction_space(child_spaces,
        #                                                             self.network,
        #                                                             ensure_subspace=node_space,
        #                                                             use_single_node_drivers=True, use_tr_trapspaces=False)

        # use time reversal trapspaces
        # terminal_restriction_space = get_terminal_restriction_space(child_spaces,
        #                                                             self.network,
        #                                                             ensure_subspace=node_space,
        #                                                             use_single_node_drivers=False, use_tr_trapspaces=True)

        # use single node drivers and time reversal trapspaces
        # terminal_restriction_space = get_terminal_restriction_space(child_spaces,
        #                                                             self.network,
        #                                                             ensure_subspace=node_space,
        #                                                             use_single_node_drivers=True, use_tr_trapspaces=True)
