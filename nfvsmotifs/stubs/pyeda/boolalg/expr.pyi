...
_KIND2EXPR = ...
def expr(obj, simplify=...): # -> Expression | Variable | _One | _Zero:
...
def expr2dimacscnf(ex): # -> tuple[Unknown, DimacsCNF]:
...
def upoint2exprpoint(upoint): # -> dict[Unknown, Unknown]:
...
class Expression(boolfunc.Function):
    ...
    def satisfy_one(self): # -> dict[Unknown, int] | dict[Unknown, Unknown] | None:
        ...
    
    def satisfy_all(self): # -> Generator[dict[Unknown, int] | dict[Unknown, Unknown] | Unknown, None, None]:
        ...
    ...
    def iter_dfs(self): # -> Generator[Unknown, None, None]:
    ...
    def pushdown_not(self): # -> Self@Expression:
    ...
    def simplify(self): # -> Self@Expression:
    ...
    def expand(self, vs=..., conj=...): # -> Self@Expression:
    ...
    def encode_inputs(self): # -> tuple[dict[Unknown, Unknown], int]:
    ...
    def tseitin(self, auxvarname=...): # -> Self@Expression:
...
class ConjNormalForm(NormalForm):
    ...
    def satisfy_one(self, assumptions=..., **params):
        """
    ...
    def satisfy_all(self, **params): # -> Generator[Unknown, None, None]:
        """Iterate through all satisfying input points."""
        ...
    
    @staticmethod
    def soln2point(soln, litmap): # -> dict[Unknown, int]:
