...
./venv/bin/python3 run_bench.py 10m ../models/random bench_sd_expand_bfs.py
# Benchmark "basic" attractor enumeration.
./venv/bin/python3 run_bench.py 10m ../models/random bench_sd_attractors_full.py
# Benchmark improved "SCC" attractor enumeration and expansion.
./venv/bin/python3 run_bench.py 10m ../models/random bench_sd_attractors_scc.py
# Benchmark simple exhaustive control.
./venv/bin/python3 run_bench.py 10m ../models/random bench_sd_control.py

zip -r perf_random_`hostname`.zip _run_*