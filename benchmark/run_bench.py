...
if __name__ == "__main__":
    ...
    def is_bench(benchmark):
        return (
            benchmark.endswith(".aeon")
            or benchmark.endswith(".bnet")
            or benchmark.endswith(".sbml")
        )
    ...
    if PARALLEL > 0:
        ...
        for bench in BENCHMARKS:
            ...
            if INTERACTIVE:
                print(
                    "Write 'skip' to go to next benchmark, 'abort' to end the run, or press enter key to continue..."
                )
