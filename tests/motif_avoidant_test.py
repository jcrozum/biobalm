...
def test_preprocessing_ssf_not_optimal():
    ...
    s0: space_type = {"x1": 0, "x2": 0}
    s1: space_type = {"x1": 0, "x2": 1}
    s2: space_type = {"x1": 1, "x2": 0}
    # s3 = {"x1": 1, "x2": 1}
...
def test_preprocessing_ssf_optimal():
    ...
    s0: space_type = {"A": 0, "B": 0, "C": 0}
    # s1 = {"A": 0, "B": 0, "C": 1}
    s2: space_type = {"A": 0, "B": 1, "C": 0}
    # s3: space_type = {"A": 0, "B": 1, "C": 1}
    s4: space_type = {"A": 1, "B": 0, "C": 0}
    # s5: space_type = {"A": 1, "B": 0, "C": 1}
    # s6: space_type = {"A": 1, "B": 1, "C": 0}
    s7: space_type = {"A": 1, "B": 1, "C": 1}
...
def test_ABNReach_current_version():
    ...
    s0: space_type = {"x1": 0, "x2": 0, "x3": 1}
    s1: space_type = {"x1": 0, "x2": 1, "x3": 1}
    # s2: space_type = {"x1": 1, "x2": 0, "x3": 1}
    s3: space_type = {"x1": 1, "x2": 1, "x3": 1}
