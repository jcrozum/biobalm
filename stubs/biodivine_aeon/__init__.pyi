...
BddPartialValuationType: TypeAlias = (
    BddPartialValuation
    | tuple[BddVariable, bool]
    | list[tuple[BddVariable, bool]]
...
class BooleanExpression:
    ...
    @staticmethod
    def from_formula(
        operator: str, arguments: list[BooleanExpression]
    ) -> BooleanExpression:
        """
...
class Bdd:
    ...
    def pick(self, variables: BddVariable | list[BddVariable]) -> Bdd:
        ...
        ...
    def pick_random(
        self, variables: BddVariable | list[BddVariable], seed: int | None = ...
    ) -> Bdd:
        """
    ...
    def clause_random(self, seed: int | None = ...) -> BddPartialValuation | None:
        ...
        ...
    def to_dot(
        self, support_set: BddVariableSet | None = ..., zero_pruned: bool = ...
    ) -> str:
        """
    ...
    def to_boolean_expression(
        self, support_set: BddVariableSet | None = ...
    ) -> BooleanExpression:
        """
...
class RegulatoryGraph:
    ...
    def num_vars(self) -> int:
        ...
        ...
    def find_regulation(
        self, source: VariableType, target: VariableType
    ) -> RegulationDict | None:
        """
    ...
    def strongly_connected_components(
        self, restriction: list[VariableType] | None = ...
    ) -> list[set[VariableId]]:
        """
        ...
        ...
    def shortest_cycle(
        self, pivot: VariableType, parity: str | None = ...
    ...
    def feedback_vertex_set(
        self, parity: str | None = ..., restriction: list[VariableType] | None = ...
    ) -> set[VariableId]:
        """
...
class BooleanNetwork(RegulatoryGraph):
    ...
    def set_update_function(
        self, variable: VariableType, expression: str | None
    ) -> None:
        """
...
class GraphVertices:
    ...
    def fix_network_variable(self, variable: VariableId, value: bool) -> GraphVertices:
        ...
        """
        ...
    def restrict_network_variable(
        self, variable: VariableId, value: bool
    ) -> GraphVertices:
        """
...
class SymbolicContext:
    ...
    def __init__(
        ...
        extra_state_variables: dict[VariableId, int] | None = ...,
    ) -> None:
        """
        ---
    ...
    def extra_state_variables(self, variable: VariableId) -> list[BddVariable]:
        ...
        """
        ...
    def extra_state_variables_by_offset(
        self, offset: int
    ) -> list[tuple[VariableId, BddVariable]]:
        """
    ...
    def get_state_variable(self, variable: VariableId) -> BddVariable:
        ...
        """
        ...
    def get_extra_state_variable(
        self, variable: VariableId, offset: int
    ) -> BddVariable:
        """
        ...
        """
        ...
    def get_implicit_function_table(
        self, variable: VariableId
    ) -> list[tuple[list[bool], BddVariable]]:
        """
        ...
        """
        ...
    def get_explicit_function_table(
    ...
    def mk_extra_state_variable_is_true(self, variable: VariableId, offset: int) -> Bdd:
        ...
        """
        ...
    def mk_uninterpreted_function_is_true(
        self, parameter: ParameterId, arguments: list[VariableId]
    ) -> Bdd:
        """
        ...
        """
        ...
    def mk_implicit_function_is_true(
        self, variable: VariableId, arguments: list[VariableId]
    ) -> Bdd:
        """
...
class SymbolicAsyncGraph:
    ...
    def __init__(self, bn: BooleanNetwork) -> None: ...
    ...
