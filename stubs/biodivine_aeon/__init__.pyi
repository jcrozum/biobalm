...
BddPartialValuationType: TypeAlias = BddPartialValuation | tuple[BddVariable, bool] | list[tuple[BddVariable, bool]] | dict[BddVariable, bool]
...
class Bdd:
    ...
    def l_and(self, other: Bdd, limit: int | None = ...) -> Bdd:
        """
    ...
    def l_or(self, other: Bdd, limit: int | None = ...) -> Bdd:
        """
    ...
    def l_imp(self, other: Bdd, limit: int | None = ...) -> Bdd:
        """
    ...
    def l_iff(self, other: Bdd, limit: int | None = ...) -> Bdd:
        """
    ...
    def l_xor(self, other: Bdd, limit: int | None = ...) -> Bdd:
        """
    ...
    def l_and_not(self, other: Bdd, limit: int | None = ...) -> Bdd:
        """
    ...
    def pick_random(self, variables: BddVariable | list[BddVariable], seed: int | None = ...) -> Bdd:
        """
    ...
    def valuation_random(self, seed: int | None = ...) -> BddValuation | None:
        """
    ...
    def clause_random(self, seed: int | None = ...) -> BddPartialValuation | None:
        """
    ...
    def to_dot(self, support_set: BddVariableSet | None = ..., zero_pruned: bool = ...) -> str:
        """
    ...
    def to_boolean_expression(self, support_set: BddVariableSet | None = ...) -> BooleanExpression:
        """
...
class RegulationDict(TypedDict):
    ...
    monotonicity: NotRequired[str | None]
    ...
...
class RegulatoryGraph:
    ...
    def add_regulation(self, regulation: RegulationDict | str) -> None:
        """
    ...
    def set_variable_name(self, variable: VariableId, name: str) -> None:
        """
    ...
    def strongly_connected_components(self, restriction: list[VariableType] | None = ...) -> list[set[VariableId]]:
        """
    ...
    def shortest_cycle(self, pivot: VariableType, parity: str | None = ...) -> list[VariableId] | None:
        """
    ...
    def feedback_vertex_set(self, parity: str | None = ..., restriction: list[VariableType] | None = ...) -> set[VariableId]:
        """
    ...
    def independent_cycles(self, parity: str | None = ..., restriction: list[VariableType] | None = ...) -> list[list[VariableId]]:
        """
...
class BooleanNetwork(RegulatoryGraph):
    ...
    def to_bnet(self, rename_if_necessary: bool = ...) -> str:
        """
    ...
    def set_update_function(self, variable: VariableType, expression: str | None) -> None:
        """
...
class ModelAnnotation:
    ...
    def append_value(self, path: list[str], extra: str) -> None:
        """
...
class GraphColors:
    ...
    def __init__(self, graph: SymbolicAsyncGraph, bdd: Bdd) -> None:
        """
        ---
...
class SymbolicContext:
    ...
    def instantiate_implicit_function(self, valuation: BddValuationType | BddPartialValuationType, variable: VariableId, arguments: list[VariableId]) -> Bdd:
        """
    ...
    def instantiate_uninterpreted_function(self, valuation: BddValuationType | BddPartialValuationType, variable: VariableId, arguments: list[VariableId]) -> Bdd:
        """
    ...
    def instantiate_fn_update(self, valuation: BddValuationType | BddPartialValuationType, function: UpdateFunction) -> Bdd:
        """
